...
svn-version?: func [
	...
	date: ask "Please give the folder date (now): "
	either empty? date [date: now] [date: to date! date]

	version: to integer! ask "Please give the folder version (custom): "
	if empty? version [version: "custom"]
